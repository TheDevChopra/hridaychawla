...
export default function AnimeHub() {
  const { items, loading, isAuthenticated, addItem, updateItem, deleteItem } = useHubItems("anime");
  ...
  return (
    <main className={styles.mainContainer}>
      ...
      <div className={styles.contentArea}>
        ...
        >
          <h1 className={styles.title}>Anime <span className="text-gradient">Hub</span></h1>
          <p className={styles.subtitle}>Track your favorites, characters, and currently airing series.</p>
        </motion.div>

        {renderSection("Masterpieces", "favorites")}
        {renderSection("Top Characters", "characters")}
