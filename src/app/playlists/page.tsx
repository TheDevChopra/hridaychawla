  ...
  return (
    <main className={styles.mainContainer}>
      ...
      <div className={styles.contentArea}>
        ...
        >
          <h1 className={styles.title}>Your <span className="text-gradient">Playlists</span></h1>
          <p className={styles.subtitle}>Curate your vibe. Stored securely on the backend.</p>
        </motion.div>

        {renderSection("My Categories", "categories")}
